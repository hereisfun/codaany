"use strict";
(self.webpackChunkCoda = self.webpackChunkCoda || []).push([[5291], {
    835291: function(e, t, r) {
        r.d(t, {
            A: function() {
                return sr
            }
        ...
        function c(e, t) {
            ...
            return e.replace(/(%[a-f0-9]{2})+/gi, (function(e) {
                ...
                for (let n = 0, o = e.length; n < o; n += 3) {
                    const s = parseInt(e.slice(n + 1, n + 3), 16);
                    if (s < 128)
                        t += r[s];
                    else {
                        if (192 == (224 & s) && n + 3 < o) {
                        ...
                        if (224 == (240 & s) && n + 6 < o) {
                            ...
                            if (128 == (192 & r) && 128 == (192 & o)) {
                                const e = s << 12 & 61440 | r << 6 & 4032 | 63 & o;
                        ...
                        if (240 == (248 & s) && n + 9 < o) {
                            ...
                            if (128 == (192 & r) && 128 == (192 & o) && 128 == (192 & i)) {
                                let e = s << 18 & 1835008 | r << 12 & 258048 | o << 6 & 4032 | 63 & i;
                                e < 65536 || e > 1114111 ? t += "����" : (e -= 65536,
                                t += String.fromCharCode(55296 + (e >> 10), 56320 + (1023 & e))),
                                n += 9;
                                continue
                            }
                        }
        ...
        function p(e, t, r) {
            ...
            for (let t = 0, s = e.length; t < s; t++) {
                ...
                if (r && 37 === i && t + 2 < s && /^[0-9a-f]{2}$/i.test(e.slice(t + 1, t + 3)))
                    o += e.slice(t, t + 3),
                    t += 2;
                else if (i < 128)
                    o += n[i];
                else if (i >= 55296 && i <= 57343) {
                    if (i >= 55296 && i <= 56319 && t + 1 < s) {
                        const r = e.charCodeAt(t + 1);
                        if (r >= 56320 && r <= 57343) {
                            o += encodeURIComponent(e[t] + e[t + 1]),
                            t++;
                            continue
                        }
                    }
        ...
        d.prototype.parse = function(e, t) {
            ...
            this.protocol = i,
            s = s.substr(i.length)),
            (t || i || s.match(/^\/\/[^@\/]+@[^@\/]+/)) && (o = "//" === s.substr(0, 2),
            !o || i && v[i] || (s = s.substr(2),
            this.slashes = !0)),
            !v[i] && (o || i && !w[i])) {
                let e, t, r = -1;
                ...
                const i = "[" === this.hostname[0] && "]" === this.hostname[this.hostname.length - 1];
                if (!i) {
            ...
            const a = s.indexOf("#");
            -1 !== a && (this.hash = s.substr(a),
            s = s.slice(0, a));
            const c = s.indexOf("?");
            return -1 !== c && (this.search = s.substr(c),
            s = s.slice(0, c)),
            s && (this.pathname = s),
            w[r] && this.hostname && !this.pathname && (this.pathname = ""),
            this
        }
        ,
        ...
        const R = new Map([[0, 65533], [128, 8364], [130, 8218], [131, 402], [132, 8222], [133, 8230], [134, 8224], [135, 8225], [136, 710], [137, 8240], [138, 352], [139, 8249], [140, 338], [142, 381], [145, 8216], [146, 8217], [147, 8220], [148, 8221], [149, 8226], [150, 8211], [151, 8212], [152, 732], [153, 8482], [154, 353], [155, 8250], [156, 339], [158, 382], [159, 376]])
          , N = null !== (_ = String.fromCodePoint) && void 0 !== _ ? _ : function(e) {
            let t = "";
        ...
        function G(e) {
            return e === z.EQUALS || function(e) {
                return e >= z.UPPER_A && e <= z.UPPER_Z || e >= z.LOWER_A && e <= z.LOWER_Z || H(e)
            }(e)
        }
        !function(e) {
        ...
        class $ {
            ...
            write(e, t) {
                switch (this.state) {
                case O.EntityStart:
                    return e.charCodeAt(t) === z.NUM ? (this.state = O.NumericStart,
                    this.consumed += 1,
                    this.stateNumericStart(e, t + 1)) : (this.state = O.NamedEntity,
            ...
            stateNumericStart(e, t) {
                return t >= e.length ? -1 : (32 | e.charCodeAt(t)) === z.LOWER_X ? (this.state = O.NumericHex,
                this.consumed += 1,
                this.stateNumericHex(e, t + 1)) : (this.state = O.NumericDecimal,
                this.stateNumericDecimal(e, t))
            }
            addToNumericResult(e, t, r, n) {
                if (t !== r) {
                    const o = r - t;
                    this.result = this.result * Math.pow(n, o) + parseInt(e.substr(t, o), n),
                    this.consumed += o
                }
            }
            stateNumericHex(e, t) {
            ...
            emitNumericEntity(e, t) {
                ...
                if (e === z.SEMI)
                    ...
                    return 0;
                return this.emitCodePoint(U(this.result), this.consumed),
                this.errors && (e !== z.SEMI && this.errors.missingSemicolonAfterCharacterReference(),
            ...
            stateNamedEntity(e, t) {
                ...
                this.excess++) {
                    ...
                    if (this.treeIndex = J(r, n, this.treeIndex + Math.max(1, o), s),
                    this.treeIndex < 0)
                        return 0 === this.result || this.decodeMode === V.Attribute && (0 === o || G(s)) ? 0 : this.emitNotTerminatedNamedEntity();
                    if (n = r[this.treeIndex],
                    o = (n & P.VALUE_LENGTH) >> 14,
                    0 !== o) {
                        if (s === z.SEMI)
                            return this.emitNamedEntityData(this.treeIndex, o, this.consumed + this.excess);
                        this.decodeMode !== V.Strict && (this.result = this.treeIndex,
            ...
            emitNamedEntityData(e, t, r) {
                ...
                return this.emitCodePoint(1 === t ? n[e] & ~P.VALUE_LENGTH : n[e + 1], r),
                ...
                switch (this.state) {
                case O.NamedEntity:
                    return 0 === this.result || this.decodeMode === V.Attribute && this.result !== this.treeIndex ? 0 : this.emitNotTerminatedNamedEntity();
                case O.NumericDecimal:
        ...
        new Map(Y([[9, "&Tab;"], [0, "&NewLine;"], [22, "&excl;"], [0, "&quot;"], [0, "&num;"], [0, "&dollar;"], [0, "&percnt;"], [0, "&amp;"], [0, "&apos;"], [0, "&lpar;"], [0, "&rpar;"], [0, "&ast;"], [0, "&plus;"], [0, "&comma;"], [1, "&period;"], [0, "&sol;"], [10, "&colon;"], [0, "&semi;"], [0, {
            v: "&lt;",
            n: 8402,
            o: "&nvlt;"
        }], [0, {
            ...
            v: "&ll;",
            n: new Map(Y([[824, "&nLtv;"], [7577, "&nLt;"]]))
        }], [0, {
            v: "&gg;",
            n: new Map(Y([[824, "&nGtv;"], [7577, "&nGt;"]]))
            ...
            n: new Map(Y([[56476, "&Ascr;"], [1, "&Cscr;"], [0, "&Dscr;"], [2, "&Gscr;"], [2, "&Jscr;"], [0, "&Kscr;"], [2, "&Nscr;"], [0, "&Oscr;"], [0, "&Pscr;"], [0, "&Qscr;"], [1, "&Sscr;"], [0, "&Tscr;"], [0, "&Uscr;"], [0, "&Vscr;"], [0, "&Wscr;"], [0, "&Xscr;"], [0, "&Yscr;"], [0, "&Zscr;"], [0, "&ascr;"], [0, "&bscr;"], [0, "&cscr;"], [0, "&dscr;"], [1, "&fscr;"], [1, "&hscr;"], [0, "&iscr;"], [0, "&jscr;"], [0, "&kscr;"], [0, "&lscr;"], [0, "&mscr;"], [0, "&nscr;"], [1, "&pscr;"], [0, "&qscr;"], [0, "&rscr;"], [0, "&sscr;"], [0, "&tscr;"], [0, "&uscr;"], [0, "&vscr;"], [0, "&wscr;"], [0, "&xscr;"], [0, "&yscr;"], [0, "&zscr;"], [52, "&Afr;"], [0, "&Bfr;"], [1, "&Dfr;"], [0, "&Efr;"], [0, "&Ffr;"], [0, "&Gfr;"], [2, "&Jfr;"], [0, "&Kfr;"], [0, "&Lfr;"], [0, "&Mfr;"], [0, "&Nfr;"], [0, "&Ofr;"], [0, "&Pfr;"], [0, "&Qfr;"], [1, "&Sfr;"], [0, "&Tfr;"], [0, "&Ufr;"], [0, "&Vfr;"], [0, "&Wfr;"], [0, "&Xfr;"], [0, "&Yfr;"], [1, "&afr;"], [0, "&bfr;"], [0, "&cfr;"], [0, "&dfr;"], [0, "&efr;"], [0, "&ffr;"], [0, "&gfr;"], [0, "&hfr;"], [0, "&ifr;"], [0, "&jfr;"], [0, "&kfr;"], [0, "&lfr;"], [0, "&mfr;"], [0, "&nfr;"], [0, "&ofr;"], [0, "&pfr;"], [0, "&qfr;"], [0, "&rfr;"], [0, "&sfr;"], [0, "&tfr;"], [0, "&ufr;"], [0, "&vfr;"], [0, "&wfr;"], [0, "&xfr;"], [0, "&yfr;"], [0, "&zfr;"], [0, "&Aopf;"], [0, "&Bopf;"], [1, "&Dopf;"], [0, "&Eopf;"], [0, "&Fopf;"], [0, "&Gopf;"], [1, "&Iopf;"], [0, "&Jopf;"], [0, "&Kopf;"], [0, "&Lopf;"], [0, "&Mopf;"], [1, "&Oopf;"], [3, "&Sopf;"], [0, "&Topf;"], [0, "&Uopf;"], [0, "&Vopf;"], [0, "&Wopf;"], [0, "&Xopf;"], [0, "&Yopf;"], [1, "&aopf;"], [0, "&bopf;"], [0, "&copf;"], [0, "&dopf;"], [0, "&eopf;"], [0, "&fopf;"], [0, "&gopf;"], [0, "&hopf;"], [0, "&iopf;"], [0, "&jopf;"], [0, "&kopf;"], [0, "&lopf;"], [0, "&mopf;"], [0, "&nopf;"], [0, "&oopf;"], [0, "&popf;"], [0, "&qopf;"], [0, "&ropf;"], [0, "&sopf;"], [0, "&topf;"], [0, "&uopf;"], [0, "&vopf;"], [0, "&wopf;"], [0, "&xopf;"], [0, "&yopf;"], [0, "&zopf;"]]))
        }], [8906, "&fflig;"], [0, "&filig;"], [0, "&fllig;"], [0, "&ffilig;"], [0, "&ffllig;"]]));
        const X = new Map([[34, "&quot;"], [38, "&amp;"], [39, "&apos;"], [60, "&lt;"], [62, "&gt;"]]);
        String.prototype.codePointAt;
        function K(e, t) {
            return function(r) {
                let n, o = 0, s = "";
                for (; n = e.exec(r); )
                    o !== n.index && (s += r.substring(o, n.index)),
        ...
        K(/[&<>'"]/g, X),
        K(/["&\u00A0]/g, new Map([[34, "&quot;"], [38, "&amp;"], [160, "&nbsp;"]])),
        K(/[&<>\u00A0]/g, new Map([[38, "&amp;"], [60, "&lt;"], [62, "&gt;"], [160, "&nbsp;"]]));
        var ee, te;
        function re(e) {
        ...
        function fe(e) {
            return e.indexOf("\\") < 0 && e.indexOf("&") < 0 ? e : e.replace(ue, (function(e, t, r) {
                return t || function(e, t) {
                    if (35 === t.charCodeAt(0) && pe.test(t)) {
        ...
        function be(e) {
            return de.test(e) ? e.replace(me, ke) : e
        }
        const ye = /[.?*+^$[\]\\(){}|-]/g;
        function Ce(e) {
            return e.replace(ye, "\\$&")
        ...
        function Fe(e, t, r) {
            ...
            let i = 0;
            for (; o < r && (n = e.charCodeAt(o),
            32 !== n) && !(n < 32 || 127 === n); )
                if (92 === n && o + 1 < r) {
                    if (32 === e.charCodeAt(o + 1))
                        break;
                    o += 2
                } else {
                    if (40 === n && (i++,
            ...
            return t === o || 0 !== i || (s.str = fe(e.slice(t, o)),
            s.pos = o,
            s.ok = !0),
            s
        }
        ...
        Se.code_inline = function(e, t, r, n, o) {
            const s = e[t];
            return "<code" + o.renderAttrs(s) + ">" + be(s.content) + "</code>"
        }
        ,
        Se.code_block = function(e, t, r, n, o) {
            const s = e[t];
            return "<pre" + o.renderAttrs(s) + "><code>" + be(e[t].content) + "</code></pre>\n"
        }
        ,
        Se.fence = function(e, t, r, n, o) {
            const s = e[t]
              , i = s.info ? fe(s.info).trim() : "";
            let a, c = "", l = "";
            if (i) {
                const e = i.split(/(\s+)/g);
                c = e[0],
            ...
            if (a = r.highlight && r.highlight(s.content, c, l) || be(s.content),
            0 === a.indexOf("<pre"))
                return a + "\n";
            if (i) {
                const e = s.attrIndex("class")
                  , t = s.attrs ? s.attrs.slice() : [];
                e < 0 ? t.push(["class", r.langPrefix + c]) : (t[e] = t[e].slice(),
        ...
        ,
        Se.image = function(e, t, r, n, o) {
            const s = e[t];
            return s.attrs[s.attrIndex("alt")][1] = o.renderInlineAsText(s.children, r, n),
            o.renderToken(e, t, r)
        }
        ,
        Se.hardbreak = function(e, t, r) {
            return r.xhtmlOut ? "<br />\n" : "<br>\n"
        }
        ,
        Se.softbreak = function(e, t, r) {
            return r.breaks ? r.xhtmlOut ? "<br />\n" : "<br>\n" : "\n"
        }
        ,
        Se.text = function(e, t) {
            return be(e[t].content)
        }
        ,
        Se.html_block = function(e, t) {
            return e[t].content
        }
        ,
        Se.html_inline = function(e, t) {
            return e[t].content
        }
        ,
        Le.prototype.renderAttrs = function(e) {
            let t, r, n;
            if (!e.attrs)
                return "";
            for (n = "",
            t = 0,
            r = e.attrs.length; t < r; t++)
                n += " " + be(e.attrs[t][0]) + '="' + be(e.attrs[t][1]) + '"';
            return n
        }
        ,
        Le.prototype.renderToken = function(e, t, r) {
            const n = e[t];
            let o = "";
            if (n.hidden)
                return "";
            ...
            o += (-1 === n.nesting ? "</" : "<") + n.tag,
            o += this.renderAttrs(n),
            0 === n.nesting && r.xhtmlOut && (o += " /");
            let s = !1;
            if (n.block && (s = !0,
            1 === n.nesting && t + 1 < e.length)) {
                const r = e[t + 1];
                ("inline" === r.type || r.hidden || -1 === r.nesting && r.tag === n.tag) && (s = !1)
            }
            return o += s ? ">\n" : ">",
            o
        }
        ,
        Le.prototype.renderInline = function(e, t, r) {
            let n = "";
            const o = this.rules;
            for (let s = 0, i = e.length; s < i; s++) {
                const i = e[s].type;
                void 0 !== o[i] ? n += o[i](e, s, t, r, this) : n += this.renderToken(e, s, t)
            }
            return n
        }
        ,
        Le.prototype.renderInlineAsText = function(e, t, r) {
            let n = "";
        ...
        ,
        Le.prototype.render = function(e, t, r) {
            let n = "";
            const o = this.rules;
            for (let s = 0, i = e.length; s < i; s++) {
                const i = e[s].type;
                "inline" === i ? n += this.renderInline(e[s].children, t, r) : void 0 !== o[i] ? n += o[i](e, s, t, r, this) : n += this.renderToken(e, s, t, r)
            }
            return n
        }
        ;
        ...
        Ie.prototype.__find__ = function(e) {
        ...
        ,
        Ie.prototype.at = function(e, t, r) {
        ...
        ,
        Ie.prototype.before = function(e, t, r, n) {
        ...
        ,
        Ie.prototype.after = function(e, t, r, n) {
            const o = this.__find__(e)
              , s = n || {};
            if (-1 === o)
                throw new Error("Parser rule not found: " + e);
        ...
        ,
        Ie.prototype.push = function(e, t, r) {
            const n = r || {};
            this.__rules__.push({
                name: e,
                enabled: !0,
        ...
        ,
        Ie.prototype.enable = function(e, t) {
            Array.isArray(e) || (e = [e]);
            const r = [];
        ...
        ,
        Ie.prototype.enableOnly = function(e, t) {
            Array.isArray(e) || (e = [e]),
        ...
        ,
        Ie.prototype.disable = function(e, t) {
            Array.isArray(e) || (e = [e]);
            const r = [];
            return e.forEach((function(e) {
                const n = this.__find__(e);
        ...
        ,
        Ie.prototype.getRules = function(e) {
        ...
        ,
        Be.prototype.attrSet = function(e, t) {
        ...
        Be.prototype.attrGet = function(e) {
            ...
            let r = null;
            return t >= 0 && (r = this.attrs[t][1]),
            r
        }
        ,
        Be.prototype.attrJoin = function(e, t) {
            const r = this.attrIndex(e);
        ...
        function Ze(e) {
            ...
            for (let r = e.length - 1; r >= 0; r--) {
                const n = e[r];
                "text" !== n.type || t || (n.content = n.content.replace(je, $e)),
        ...
        function Je(e) {
            ...
            for (let r = e.length - 1; r >= 0; r--) {
                const n = e[r];
                "text" !== n.type || t || Ve.test(n.content) && (n.content = n.content.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1—").replace(/(^|\s)--(?=\s|$)/gm, "$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1–")),
                "link_open" === n.type && "auto" === n.info && t--,
                "link_close" === n.type && "auto" === n.info && t++
            }
        }
        ...
        function Xe(e, t) {
            ...
            for (let o = 0; o < e.length; o++) {
                ...
                e: for (; c < l; ) {
                    ...
                    const g = ve(d) || Ee(String.fromCharCode(d))
                      , k = ve(m) || Ee(String.fromCharCode(m))
                      , b = Ae(d)
                      , y = Ae(m);
                    if (y ? p = !1 : k && (b || g || (p = !1)),
                    b ? h = !1 : g && (y || k || (h = !1)),
                    34 === m && '"' === u[0] && d >= 48 && d <= 57 && (h = p = !1),
                    p && h && (p = g,
                    h = k),
                    p || h) {
                        if (h)
                            for (r = n.length - 1; r >= 0; r--) {
                                ...
                                if (n[r].level < i)
                                    break;
                                if (p.single === f && n[r].level === i) {
                                    let i, h;
                                    p = n[r],
                                    f ? (i = t.md.options.quotes[2],
                                    h = t.md.options.quotes[3]) : (i = t.md.options.quotes[0],
                                    h = t.md.options.quotes[1]),
                                    s.content = Ye(s.content, u.index, h),
                                    e[p.token].content = Ye(e[p.token].content, p.pos, i),
                                    c += h.length - 1,
                                    p.token === o && (c += i.length - 1),
                                    a = s.content,
                                    l = a.length,
                                    n.length = r;
                                    continue e
                        ...
                        p ? n.push({
                            ...
                            single: f,
                            level: i
                        }) : h && f && (s.content = Ye(s.content, u.index, "’"))
                    } else
                        f && (s.content = Ye(s.content, u.index, "’"))
                }
            }
        }
        const Ke = [["normalize", function(e) {
            let t;
            t = e.src.replace(ze, "\n"),
            t = t.replace(Pe, "�"),
            e.src = t
            ...
            if (e.md.options.linkify)
                for (let n = 0, o = t.length; n < o; n++) {
                    if ("inline" !== t[n].type || !e.md.linkify.pretest(t[n].content))
                        continue;
                    let o = t[n].children
                      , s = 0;
                    for (let i = o.length - 1; i >= 0; i--) {
                        ...
                        if ("link_close" !== a.type) {
                            if ("html_inline" === a.type && (r = a.content,
                            /^<a[>\s]/i.test(r) && s > 0 && s--,
                            Oe(a.content) && s++),
                            !(s > 0) && "text" === a.type && e.md.linkify.test(a.content)) {
                                const r = a.content;
                                let s = e.md.linkify.match(r);
                                const c = [];
                                let l = a.level
                                  , u = 0;
                                s.length > 0 && 0 === s[0].index && i > 0 && "text_special" === o[i - 1].type && (s = s.slice(1));
                                for (let t = 0; t < s.length; t++) {
                                    ...
                                    if (!e.md.validateLink(o))
                                        continue;
                                    let i = s[t].text;
                                    i = s[t].schema ? "mailto:" !== s[t].schema || /^mailto:/i.test(i) ? e.md.normalizeLinkText(i) : e.md.normalizeLinkText("mailto:" + i).replace(/^mailto:/, "") : e.md.normalizeLinkText("http://" + i).replace(/^http:\/\//, "");
                                    const a = s[t].index;
                                    if (a > u) {
                                        const t = new e.Token("text","",0);
                                        t.content = r.slice(u, a),
                                        t.level = l,
                                        c.push(t)
                                    }
                                ...
                                t[n].children = o = ie(o, i, c)
                            }
                        } else
                            for (i--; o[i].level !== a.level && "link_open" !== o[i].type; )
                                i--
                    }
                }
        }
            ...
            if (e.md.options.typographer)
                for (t = e.tokens.length - 1; t >= 0; t--)
                    "inline" === e.tokens[t].type && (He.test(e.tokens[t].content) && Ze(e.tokens[t].children),
                    Ve.test(e.tokens[t].content) && Je(e.tokens[t].children))
        }
        ], ["smartquotes", function(e) {
            if (e.md.options.typographer)
                for (let t = e.tokens.length - 1; t >= 0; t--)
                    "inline" === e.tokens[t].type && We.test(e.tokens[t].content) && Xe(e.tokens[t].children, e)
        }
            ...
            for (let e = 0; e < o; e++) {
                ...
                const o = n[e].children
                  , s = o.length;
                for (t = 0; t < s; t++)
                    "text_special" === o[t].type && (o[t].type = "text");
                for (t = r = 0; t < s; t++)
                    "text" === o[t].type && t + 1 < s && "text" === o[t + 1].type ? o[t + 1].content = o[t].content + o[t + 1].content : (t !== r && (o[r] = o[t]),
                    r++);
                t !== r && (o.length = r)
            }
        }
        ...
        function rt(e, t, r, n) {
            ...
            this.level = 0;
            const o = this.src;
            for (let e = 0, t = 0, r = 0, n = 0, s = o.length, i = !1; t < s; t++) {
        ...
        rt.prototype.getLines = function(e, t, r, n) {
            ...
            for (let s = 0, i = e; i < t; i++,
            s++) {
                let e = 0;
                const a = this.bMarks[i];
                let c, l = a;
                for (c = i + 1 < t || n ? this.eMarks[i] + 1 : this.eMarks[i]; l < c && e < r; ) {
                    const t = this.src.charCodeAt(l);
                    if (De(t))
                        9 === t ? e += 4 - (e + this.bsCount[i]) % 4 : e++;
                    else {
                        if (!(l - a < this.tShift[i]))
                            break;
                        e++
                    }
                    l++
                }
                o[s] = e > r ? new Array(e - r + 1).join(" ") + this.src.slice(l, c) : this.src.slice(l, c)
            }
            return o.join("")
        }
        ,
        rt.prototype.Token = Re;
        var nt = rt;
        function ot(e, t) {
        ...
        function st(e) {
            ...
            let n = 0
              ...
              , a = "";
            for (; n < r; )
                124 === o && (s ? (a += e.substring(i, n - 1),
                i = n) : (t.push(a + e.substring(i, n)),
                a = "",
                i = n + 1)),
                s = 92 === o,
                n++,
                o = e.charCodeAt(n);
            return t.push(a + e.substring(i)),
            t
        }
        function it(e, t) {
            const r = e.eMarks[t];
        ...
        function at(e, t) {
            ...
            return o < n && (s = e.src.charCodeAt(o),
            !De(s)) ? -1 : o
        }
        const ct = "<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^\"'=<>`\\x00-\\x20]+|'[^']*'|\"[^\"]*\"))?)*\\s*\\/?>"
          , lt = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>"
          , ut = new RegExp("^(?:" + ct + "|" + lt + "|\x3c!---?>|\x3c!--(?:[^-]|-[^-]|--[^>])*--\x3e|<[?][\\s\\S]*?[?]>|<![A-Za-z][^>]*>|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>)")
          , pt = new RegExp("^(?:" + ct + "|" + lt + ")")
          , ht = [[/^<(script|pre|style|textarea)(?=(\s|>|$))/i, /<\/(script|pre|style|textarea)>/i, !0], [/^<!--/, /-->/, !0], [/^<\?/, /\?>/, !0], [/^<![A-Z]/, />/, !0], [/^<!\[CDATA\[/, /\]\]>/, !0], [new RegExp("^</?(" + ["address", "article", "aside", "base", "basefont", "blockquote", "body", "caption", "center", "col", "colgroup", "dd", "details", "dialog", "dir", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hr", "html", "iframe", "legend", "li", "link", "main", "menu", "menuitem", "nav", "noframes", "ol", "optgroup", "option", "p", "param", "search", "section", "summary", "table", "tbody", "td", "tfoot", "th", "thead", "title", "tr", "track", "ul"].join("|") + ")(?=(\\s|/?>|$))","i"), /^$/, !0], [new RegExp(pt.source + "\\s*$"), /^$/, !1]];
        const ft = [["table", function(e, t, r, n) {
            if (t + 2 > r)
                return !1;
            let o = t + 1;
            ...
            if (124 !== a && 45 !== a && 58 !== a && !De(a))
                return !1;
            if (45 === i && De(a))
                return !1;
            for (; s < e.eMarks[o]; ) {
                const t = e.src.charCodeAt(s);
                if (124 !== t && 45 !== t && 58 !== t && !De(t))
                    return !1;
                s++
            }
            let c = ot(e, t + 1)
            ...
            for (let t = 0; t < l.length; t++) {
                ...
                u[t] && (r.attrs = [["style", "text-align:" + u[t]]]);
            ...
            for (o = t + 2; o < r && !(e.sCount[o] < e.blkIndent); o++) {
                ...
                for (let t = 0; t < p; t++) {
                    ...
                    u[t] && (r.attrs = [["style", "text-align:" + u[t]]]);
                    const n = e.push("inline", "", 0);
                    n.content = l[t] ? l[t].trim() : "",
                    n.children = [],
                    e.push("td_close", "td", -1)
                }
                e.push("tr_close", "tr", -1)
            }
            return m && (e.push("tbody_close", "tbody", -1),
            m[1] = o),
        ...
        , ["paragraph", "reference"]], ["code", function(e, t, r) {
            ...
            return s.content = e.getLines(t, o, 4 + e.blkIndent, !1) + "\n",
            s.map = [t, e.line],
            !0
        }
            ...
            const l = e.src.slice(a, o)
              , u = e.src.slice(o, s);
            if (96 === i && u.indexOf(String.fromCharCode(i)) >= 0)
                return !1;
            if (n)
                return !0;
            let p = t
              , h = !1;
            for (; (p++,
            !(p >= r)) && (o = a = e.bMarks[p] + e.tShift[p],
            s = e.eMarks[p],
            !(o < s && e.sCount[p] < e.blkIndent)); )
                if (e.src.charCodeAt(o) === i && !(e.sCount[p] - e.blkIndent >= 4 || (o = e.skipChars(o, i),
                o - a < c || (o = e.skipSpaces(o),
                o < s)))) {
                    h = !0;
                    break
                }
            ...
            return f.info = u,
            f.content = e.getLines(t + 1, p, c, !0),
            f.markup = l,
            f.map = [t, e.line],
            !0
        }
        , ["paragraph", "reference", "blockquote", "list"]], ["blockquote", function(e, t, r, n) {
            let o = e.bMarks[t] + e.tShift[t]
              , s = e.eMarks[t];
            const i = e.lineMax;
            if (e.sCount[t] - e.blkIndent >= 4)
                return !1;
            if (62 !== e.src.charCodeAt(o))
                return !1;
            if (n)
                return !0;
            const a = []
            ...
            for (f = t; f < r; f++) {
                ...
                if (62 === e.src.charCodeAt(o++) && !t) {
                    ...
                    n++,
                    r = !1,
                    t = !0) : 9 === e.src.charCodeAt(o) ? (t = !0,
                    (e.bsCount[f] + n) % 4 == 3 ? (o++,
                    n++,
                    r = !1) : r = !0) : t = !1;
                    let i = n;
                    for (a.push(e.bMarks[f]),
                    e.bMarks[f] = o; o < s; ) {
                        const t = e.src.charCodeAt(o);
                        if (!De(t))
                            break;
                        9 === t ? i += 4 - (i + e.bsCount[f] + (r ? 1 : 0)) % 4 : i++,
                        o++
                    }
                    d = o >= s,
                    c.push(e.bsCount[f]),
                ...
                if (n) {
                    e.lineMax = f,
                    0 !== e.blkIndent && (a.push(e.bMarks[f]),
                    c.push(e.bsCount[f]),
                    u.push(e.tShift[f]),
                    l.push(e.sCount[f]),
            ...
            for (let r = 0; r < u.length; r++)
                ...
                e.sCount[r + t] = l[r],
                e.bsCount[r + t] = c[r];
            return e.blkIndent = m,
            !0
        }
        , ["paragraph", "reference", "blockquote", "list"]], ["hr", function(e, t, r, n) {
            const o = e.eMarks[t];
            if (e.sCount[t] - e.blkIndent >= 4)
                return !1;
            ...
            return c.map = [t, e.line],
            c.markup = Array(a + 1).join(String.fromCharCode(i)),
            !0
        }
        , ["paragraph", "reference", "blockquote", "list"]], ["list", function(e, t, r, n) {
            let o, s, i, a, c = t, l = !0;
            if (e.sCount[c] - e.blkIndent >= 4)
                return !1;
            if (e.listIndent >= 0 && e.sCount[c] - e.listIndent >= 4 && e.sCount[c] < e.blkIndent)
                return !1;
            let u, p, h, f = !1;
            if (n && "paragraph" === e.parentType && e.sCount[c] >= e.blkIndent && (f = !0),
            (h = at(e, c)) >= 0) {
                if (u = !0,
                i = e.bMarks[c] + e.tShift[c],
                p = Number(e.src.slice(i, h - 1)),
                f && 1 !== p)
                    return !1
            } else {
                if (!((h = it(e, c)) >= 0))
            ...
            if (f && e.skipSpaces(h) >= e.eMarks[c])
                return !1;
            if (n)
                return !0;
            const d = e.src.charCodeAt(h - 1)
              , m = e.tokens.length;
            u ? (a = e.push("ordered_list_open", "ol", 1),
            1 !== p && (a.attrs = [["start", p]])) : a = e.push("bullet_list_open", "ul", 1);
            const g = [c, 0];
            a.map = g,
            ...
            for (e.parentType = "list"; c < r; ) {
                s = h,
                o = e.eMarks[c];
                const t = e.sCount[c] + h - (e.bMarks[c] + e.tShift[c]);
                let n = t;
                for (; s < o; ) {
                    const t = e.src.charCodeAt(s);
                    if (9 === t)
                ...
                f > 4 && (f = 1);
                const m = t + f;
                a = e.push("list_item_open", "li", 1),
                a.markup = String.fromCharCode(d);
                const g = [c, 0];
                a.map = g,
                u && (a.info = e.src.slice(i, h - 1));
                const y = e.tight
                  , C = e.tShift[c]
                  , D = e.sCount[c]
                  , A = e.listIndent;
                if (e.listIndent = e.blkIndent,
                e.blkIndent = m,
                e.tight = !0,
                e.tShift[c] = p - e.bMarks[c],
                e.sCount[c] = n,
                p >= o && e.isEmpty(c + 1) ? e.line = Math.min(e.line + 2, r) : e.md.block.tokenize(e, c, r, !0),
                e.tight && !k || (l = !1),
                k = e.line - c > 1 && e.isEmpty(e.line - 1),
                e.blkIndent = e.listIndent,
                e.listIndent = A,
                e.tShift[c] = C,
                e.sCount[c] = D,
                e.tight = y,
                a = e.push("list_item_close", "li", -1),
                a.markup = String.fromCharCode(d),
                c = e.line,
                g[1] = c,
                c >= r)
            ...
            return a = u ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1),
            a.markup = String.fromCharCode(d),
            g[1] = c,
            e.line = c,
            e.parentType = y,
            l && function(e, t) {
                const r = e.level + 2;
                for (let n = t + 2, o = e.tokens.length - 2; n < o; n++)
        ...
        , ["paragraph", "reference", "blockquote"]], ["reference", function(e, t, r, n) {
            let o = e.bMarks[t] + e.tShift[t]
              , s = e.eMarks[t]
              , i = t + 1;
            if (e.sCount[t] - e.blkIndent >= 4)
                return !1;
            if (91 !== e.src.charCodeAt(o))
                return !1;
            function a(t) {
                const r = e.lineMax;
                if (t >= r || e.isEmpty(t))
                    return null;
                let n = !1;
                if (e.sCount[t] - e.blkIndent > 3 && (n = !0),
                e.sCount[t] < 0 && (n = !0),
                !n) {
                ...
                const o = e.bMarks[t] + e.tShift[t]
                  , s = e.eMarks[t];
                return e.src.slice(o, s + 1)
            }
            let c = e.src.slice(o, s + 1);
            s = c.length;
            let l = -1;
            for (o = 1; o < s; o++) {
            ...
            const u = e.md.helpers.parseLinkDestination(c, o, s);
            if (!u.ok)
                return !1;
            const p = e.md.normalizeLink(u.str);
            ...
            let m, g = e.md.helpers.parseLinkTitle(c, o, s);
            for (; g.can_continue; ) {
                const t = a(i);
                if (null === t)
                    break;
                ...
                s = c.length,
                i++,
                g = e.md.helpers.parseLinkTitle(c, o, s, g)
            }
            for (o < s && d !== o && g.ok ? (m = g.str,
            o = g.pos) : (m = "",
            o = h,
            i = f); o < s; ) {
                if (!De(c.charCodeAt(o)))
                    break;
                o++
            }
            if (o < s && 10 !== c.charCodeAt(o) && m)
                for (m = "",
                o = h,
                i = f; o < s; ) {
                    if (!De(c.charCodeAt(o)))
            ...
            if (o < s && 10 !== c.charCodeAt(o))
                return !1;
            const k = we(c.slice(1, l));
            return !!k && (n || (void 0 === e.env.references && (e.env.references = {}),
            void 0 === e.env.references[k] && (e.env.references[k] = {
                title: m,
                href: p
            }),
            e.line = i),
            ...
            if (!e.md.options.html)
                return !1;
            if (60 !== e.src.charCodeAt(o))
                return !1;
            let i = e.src.slice(o, s)
              , a = 0;
            for (; a < ht.length && !ht[a][0].test(i); a++)
                ;
            if (a === ht.length)
                return !1;
            if (n)
            ...
            return l.map = [t, c],
            l.content = e.getLines(t, c, e.blkIndent, !0),
            !0
        }
        , ["paragraph", "reference", "blockquote"]], ["heading", function(e, t, r, n) {
            ...
            if (35 !== i || o >= s)
                return !1;
            let a = 1;
            for (i = e.src.charCodeAt(++o); 35 === i && o < s && a <= 6; )
                a++,
            ...
            const c = e.skipCharsBack(s, 35, o);
            c > o && De(e.src.charCodeAt(c - 1)) && (s = c),
            e.line = t + 1;
            const l = e.push("heading_open", "h" + String(a), 1);
            l.markup = "########".slice(0, a),
            l.map = [t, e.line];
            const u = e.push("inline", "", 0);
            return u.content = e.src.slice(o, s).trim(),
            u.map = [t, e.line],
            u.children = [],
            e.push("heading_close", "h" + String(a), -1).markup = "########".slice(0, a),
            !0
        }
        , ["paragraph", "reference", "blockquote"]], ["lheading", function(e, t, r) {
            ...
            for (; a < r && !e.isEmpty(a); a++) {
                ...
                if (e.sCount[a] >= e.blkIndent) {
                    ...
                    const r = e.eMarks[a];
                    if (t < r && (s = e.src.charCodeAt(t),
                    (45 === s || 61 === s) && (t = e.skipChars(t, s),
                    t = e.skipSpaces(t),
                    t >= r))) {
                        i = 61 === s ? 1 : 2;
                        break
            ...
            l.markup = String.fromCharCode(s),
            l.map = [t, e.line];
            const u = e.push("inline", "", 0);
            return u.content = c,
            u.map = [t, e.line - 1],
            u.children = [],
            e.push("heading_close", "h" + String(i), -1).markup = String.fromCharCode(s),
            e.parentType = o,
            !0
        }
            ...
            const i = e.getLines(t, s, e.blkIndent, !1).trim();
            e.line = s,
        ...
        function dt() {
            ...
            for (let e = 0; e < ft.length; e++)
                this.ruler.push(ft[e][0], ft[e][1], {
                    alt: (ft[e][2] || []).slice()
                })
        }
        dt.prototype.tokenize = function(e, t, r) {
            const n = this.ruler.getRules("")
              , o = n.length
              , s = e.md.options.maxNesting;
            let i = t
              , a = !1;
            for (; i < r && (e.line = i = e.skipEmptyLines(i),
        ...
        gt.prototype.scanDelims = function(e, t) {
            ...
            for (; s < r && this.src.charCodeAt(s) === n; )
                s++;
            const i = s - e
              , a = s < r ? this.src.charCodeAt(s) : 32
              , c = ve(o) || Ee(String.fromCharCode(o))
              , l = ve(a) || Ee(String.fromCharCode(a))
              , u = Ae(o)
              , p = Ae(a)
              , h = !p && (!l || u || c)
              , f = !u && (!c || p || l);
        ...
        function Dt(e, t) {
            ...
            for (; n.length; ) {
                const t = n.pop();
                let o = t + 1;
                for (; o < e.tokens.length && "s_close" === e.tokens[o].type; )
                    o++;
                o--,
                t !== o && (r = e.tokens[o],
        ...
        var At = {
            ...
            postProcess: function(e) {
                ...
                Dt(e, e.delimiters);
                for (let n = 0; n < r; n++)
                    t[n] && t[n].delimiters && Dt(e, t[n].delimiters)
            }
        };
        function Et(e, t) {
            for (let r = t.length - 1; r >= 0; r--) {
                const n = t[r];
                if (95 !== n.marker && 42 !== n.marker)
                    continue;
                if (-1 === n.end)
                    continue;
                const o = t[n.end]
                  , s = r > 0 && t[r - 1].end === n.end + 1 && t[r - 1].marker === n.marker && t[r - 1].token === n.token - 1 && t[n.end + 1].token === o.token + 1
                ...
                c.markup = s ? i + i : i,
                c.content = "",
                s && (e.tokens[t[r - 1].token].content = "",
        ...
        var vt = {
            ...
            postProcess: function(e) {
                ...
                Et(e, e.delimiters);
                for (let n = 0; n < r; n++)
                    t[n] && t[n].delimiters && Et(e, t[n].delimiters)
            }
        };
        const wt = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/
          , _t = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
        const xt = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i
          , Ft = /^&([a-z][a-z0-9]{1,31});/i;
        function qt(e) {
            const t = {}
              , r = e.length;
            if (!r)
            ...
            for (let i = 0; i < r; i++) {
                const r = e[i];
                if (s.push(0),
                e[n].marker === r.marker && o === r.token - 1 || (n = i),
                o = r.token,
                r.length = r.length || 0,
                !r.close)
                    continue;
                ...
                for (; c > a; c -= s[c] + 1) {
                    ...
                    if (t.marker === r.marker && (t.open && t.end < 0)) {
                        let n = !1;
                        if ((t.close || r.open) && (t.length + r.length) % 3 == 0 && (t.length % 3 == 0 && r.length % 3 == 0 || (n = !0)),
                        !n) {
                            const n = c > 0 && !e[c - 1].open ? s[c - 1] + 1 : 0;
                            s[i] = i - c + n,
                            s[c] = n,
                            r.open = !1,
                            t.end = i,
        ...
        const St = [["text", function(e, t) {
            let r = e.pos;
            for (; r < e.posMax && !bt(e.src.charCodeAt(r)); )
                r++;
            ...
            if (r + 3 > e.posMax)
                return !1;
            if (58 !== e.src.charCodeAt(r))
                return !1;
            if (47 !== e.src.charCodeAt(r + 1))
                return !1;
            if (47 !== e.src.charCodeAt(r + 2))
                return !1;
            const n = e.pending.match(yt);
            if (!n)
                return !1;
            const o = n[1]
              , s = e.md.linkify.matchAtStart(e.src.slice(r - o.length));
            if (!s)
                return !1;
            let i = s.url;
            ...
            return e.pos += i.length - o.length,
            !0
        }
        ], ["newline", function(e, t) {
            let r = e.pos;
            if (10 !== e.src.charCodeAt(r))
                return !1;
            ...
            if (!t)
                if (n >= 0 && 32 === e.pending.charCodeAt(n))
                    ...
                    e.push("softbreak", "br", 0);
            for (r++; r < o && De(e.src.charCodeAt(r)); )
                r++;
            return e.pos = r,
            !0
        }
            ...
            if (o >= 55296 && o <= 56319 && r + 1 < n) {
                ...
                t >= 56320 && t <= 57343 && (s += e.src[r + 1],
                r++)
            }
            const i = "\\" + s;
            if (!t) {
                const t = e.push("text_special", "", 0);
                o < 256 && 0 !== Ct[o] ? t.content = s : t.content = i,
                t.markup = i,
                t.info = "escape"
            }
            return e.pos = r + 1,
            ...
            let r = e.pos;
            if (96 !== e.src.charCodeAt(r))
                return !1;
            const n = r;
            r++;
            const o = e.posMax;
            for (; r < o && 96 === e.src.charCodeAt(r); )
                r++;
            const s = e.src.slice(n, r)
              , i = s.length;
            if (e.backticksScanned && (e.backticks[i] || 0) <= n)
                return t || (e.pending += s),
                e.pos += i,
                !0;
            let a, c = r;
            for (; -1 !== (a = e.src.indexOf("`", c)); ) {
                for (c = a + 1; c < o && 96 === e.src.charCodeAt(c); )
                    c++;
                const n = c - a;
                if (n === i) {
                    if (!t) {
                        ...
                        t.markup = s,
                        t.content = e.src.slice(r, a).replace(/\n/g, " ").replace(/^ (.+) $/, "$1")
                    }
                    return e.pos = c,
                    !0
                }
        ...
        ], ["strikethrough", At.tokenize], ["emphasis", vt.tokenize], ["link", function(e, t) {
            let r, n, o, s, i = "", a = "", c = e.pos, l = !0;
            ...
            if (f < 0)
                return !1;
            let d = f + 1;
            if (d < p && 40 === e.src.charCodeAt(d)) {
                for (l = !1,
                d++; d < p && (r = e.src.charCodeAt(d),
                De(r) || 10 === r); d++)
                    ;
                if (d >= p)
                    return !1;
                if (c = d,
                o = e.md.helpers.parseLinkDestination(e.src, d, e.posMax),
                o.ok) {
                    for (i = e.md.normalizeLink(o.str),
                    e.md.validateLink(i) ? d = o.pos : i = "",
                    c = d; d < p && (r = e.src.charCodeAt(d),
                    De(r) || 10 === r); d++)
                        ;
                    if (o = e.md.helpers.parseLinkTitle(e.src, d, e.posMax),
                    d < p && c !== d && o.ok)
                        for (a = o.str,
                        d = o.pos; d < p && (r = e.src.charCodeAt(d),
                        De(r) || 10 === r); d++)
                            ;
                }
                (d >= p || 41 !== e.src.charCodeAt(d)) && (l = !0),
                d++
            }
            if (l) {
                if (void 0 === e.env.references)
                    return !1;
                if (d < p && 91 === e.src.charCodeAt(d) ? (c = d + 1,
                d = e.md.helpers.parseLinkLabel(e, d),
                d >= 0 ? n = e.src.slice(c, d++) : d = f + 1) : d = f + 1,
                n || (n = e.src.slice(h, f)),
                s = e.env.references[we(n)],
                !s)
                    return e.pos = u,
                    !1;
                i = s.href,
            ...
            if (d < 0)
                return !1;
            if (s = d + 1,
            s < h && 40 === e.src.charCodeAt(s)) {
                for (s++; s < h && (r = e.src.charCodeAt(s),
                De(r) || 10 === r); s++)
                    ;
                if (s >= h)
                    return !1;
                for (l = s,
                a = e.md.helpers.parseLinkDestination(e.src, s, e.posMax),
                a.ok && (u = e.md.normalizeLink(a.str),
                e.md.validateLink(u) ? s = a.pos : u = ""),
                l = s; s < h && (r = e.src.charCodeAt(s),
                De(r) || 10 === r); s++)
                    ;
                if (a = e.md.helpers.parseLinkTitle(e.src, s, e.posMax),
                s < h && l !== s && a.ok)
                    for (c = a.str,
                    s = a.pos; s < h && (r = e.src.charCodeAt(s),
                    De(r) || 10 === r); s++)
                        ;
                else
                    c = "";
                ...
                if (void 0 === e.env.references)
                    return !1;
                if (s < h && 91 === e.src.charCodeAt(s) ? (l = s + 1,
                s = e.md.helpers.parseLinkLabel(e, s),
                s >= 0 ? o = e.src.slice(l, s++) : s = d + 1) : s = d + 1,
                o || (o = e.src.slice(f, d)),
                i = e.env.references[we(o)],
                !i)
                    return e.pos = p,
                    !1;
                u = i.href,
            ...
            const s = e.src.slice(n + 1, r);
            if (_t.test(s)) {
                const r = e.md.normalizeLink(s);
                if (!e.md.validateLink(r))
                    return !1;
                if (!t) {
                    const t = e.push("link_open", "a", 1);
                    t.attrs = [["href", r]],
                ...
                return e.pos += s.length + 2,
                !0
            }
            if (wt.test(s)) {
                const r = e.md.normalizeLink("mailto:" + s);
                if (!e.md.validateLink(r))
                    return !1;
                if (!t) {
                    const t = e.push("link_open", "a", 1);
            ...
            const r = e.posMax
              , n = e.pos;
            if (60 !== e.src.charCodeAt(n) || n + 2 >= r)
                return !1;
            ...
            if (33 !== o && 63 !== o && 47 !== o && !function(e) {
                ...
                return !1;
            const s = e.src.slice(n).match(ut);
            if (!s)
                return !1;
            if (!t) {
            ...
            var i;
            return e.pos += s[0].length,
            !0
        }
        ], ["entity", function(e, t) {
            const r = e.pos
              , n = e.posMax;
            if (38 !== e.src.charCodeAt(r))
                return !1;
            if (r + 1 >= n)
                return !1;
            if (35 === e.src.charCodeAt(r + 1)) {
                const n = e.src.slice(r).match(xt);
                if (n) {
                    if (!t) {
                        const t = "x" === n[1][0].toLowerCase() ? parseInt(n[1].slice(1), 16) : parseInt(n[1], 10)
                          , r = e.push("text_special", "", 0);
                        r.content = ae(t) ? ce(t) : ce(65533),
                        r.markup = n[0],
                        r.info = "entity"
                    }
                    return e.pos += n[0].length,
                    !0
                }
            } else {
                const n = e.src.slice(r).match(Ft);
                if (n) {
                    const r = Q(n[0]);
                    if (r !== n[0]) {
                        if (!t) {
          ...
          , Lt = [["balance_pairs", function(e) {
            const t = e.tokens_meta
              , r = e.tokens_meta.length;
            qt(e.delimiters);
            for (let e = 0; e < r; e++)
                t[e] && t[e].delimiters && qt(t[e].delimiters)
        }
        ], ["strikethrough", At.postProcess], ["emphasis", vt.postProcess], ["fragments_join", function(e) {
            let t, r, n = 0;
            const o = e.tokens
              , s = e.tokens.length;
            for (t = r = 0; t < s; t++)
        ...
        function Tt() {
            ...
            for (let e = 0; e < St.length; e++)
                this.ruler.push(St[e][0], St[e][1]);
            this.ruler2 = new Me;
            for (let e = 0; e < Lt.length; e++)
                this.ruler2.push(Lt[e][0], Lt[e][1])
        }
        Tt.prototype.skipToken = function(e) {
            const t = e.pos
        ...
        ,
        Tt.prototype.tokenize = function(e) {
            const t = this.ruler.getRules("")
              , r = t.length
              , n = e.posMax
              , o = e.md.options.maxNesting;
        ...
        ,
        Tt.prototype.parse = function(e, t, r, n) {
            const o = new this.State(e,t,r,n);
            this.tokenize(o);
            const s = this.ruler2.getRules("")
              , i = s.length;
            for (let e = 0; e < i; e++)
                s[e](o)
        }
        ,
        Tt.prototype.State = kt;
        var It = Tt
          , Mt = r(80726);
        const Bt = 2147483647
          , Rt = 36
        ...
        const $t = function(e, t) {
          ...
          , Zt = function(e, t, r) {
            let n = 0;
            for (e = r ? Ot(e / 700) : e >> 1,
            e += Ot(e / t); e > 455; n += Rt)
                e = Ot(e / 35);
            return Ot(n + 36 * e / (e + 38))
        }
          , Jt = function(e) {
            const t = []
              , r = e.length;
            ...
            i < 0 && (i = 0);
            for (let r = 0; r < i; ++r)
                e.charCodeAt(r) >= 128 && Ht("not-basic"),
                t.push(e.charCodeAt(r));
            for (let c = i > 0 ? i + 1 : 0; c < r; ) {
                const i = n;
                for (let t = 1, o = Rt; ; o += Rt) {
                    c >= r && Ht("invalid-input");
                    const i = (a = e.charCodeAt(c++)) >= 48 && a < 58 ? a - 48 + 26 : a >= 65 && a < 91 ? a - 65 : a >= 97 && a < 123 ? a - 97 : Rt;
                    i >= Rt && Ht("invalid-input"),
                    i > Ot((Bt - n) / t) && Ht("overflow"),
                    n += i * t;
                    const l = o <= s ? 1 : o >= s + 26 ? 26 : o - s;
                    if (i < l)
                        break;
                    const u = Rt - l;
                    t > Ot(Bt / u) && Ht("overflow"),
                    t *= u
                }
                const l = t.length + 1;
                s = Zt(n - i, l, 0 == i),
                Ot(n / l) > Bt - o && Ht("overflow"),
                o += Ot(n / l),
                n %= l,
                t.splice(n++, 0, o)
            }
          ...
          , Wt = function(e) {
            ...
            for (i && t.push("-"); a < r; ) {
                ...
                for (const t of e)
                    t >= n && t < r && (r = t);
                const c = a + 1;
                r - n > Ot((Bt - o) / c) && Ht("overflow"),
                o += (r - n) * c,
                n = r;
                for (const r of e)
                    if (r < n && ++o > Bt && Ht("overflow"),
                    r === n) {
                        let e = o;
                        for (let r = Rt; ; r += Rt) {
        ...
        var Qt = {
            ...
            toUnicode: function(e) {
                return jt(e, (function(e) {
                    return Nt.test(e) ? Jt(e.slice(4).toLowerCase()) : e
                }
                ))
            }
        };
        const Yt = {
          ...
          , Kt = /^data:image\/(gif|png|jpeg|webp);/;
        function er(e) {
            const t = e.trim().toLowerCase();
            return !Xt.test(t) || Kt.test(t)
        }
        const tr = ["http:", "https:", "mailto:"];
        function rr(e) {
            const t = x(e, !0);
            if (t.hostname && (!t.protocol || tr.indexOf(t.protocol) >= 0))
                try {
                    t.hostname = Qt.toASCII(t.hostname)
                } catch (e) {}
            return h(f(t))
        }
        function nr(e) {
            ...
            if (t.hostname && (!t.protocol || tr.indexOf(t.protocol) >= 0))
                try {
                    t.hostname = Qt.toUnicode(t.hostname)
                } catch (e) {}
            return l(f(t), l.defaultChars + "%")
        }
        function or(e, t) {
            ...
            this.linkify = new Mt.A,
            this.validateLink = er,
            this.normalizeLink = rr,
            this.normalizeLinkText = nr,
            this.utils = s,
            this.helpers = se({}, i),
            this.options = {},
            this.configure(e),
